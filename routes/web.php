...
/** Newsletter routes */
Route::post('newsletter', [NewsLetterController::class, 'newsLetterRequset'])->name('newsletter');
Route::get('verify/{token}', [NewsletterController::class, 'newsLetterEmailVarify'])->name('verify');
...
/** vendor page routes */
Route::get('vvendor', [HomeController::class, 'vendorPage'])->name('vvendor.index');
Route::get('vendor-product/{id}', [HomeController::class, 'vendorProductsPage'])->name('vendor.products');
